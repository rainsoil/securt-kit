...
//        // 5. 更新操作演示
    ...
    private void demonstrateBatchOperations() {
        ...
        List<User> users = Arrays.asList(
                ...
                createTestUser("批量用户2", "13800138010", "batch1@example.com", "110101199001010010"),
                createTestUser("批量用户3", "13800138010", "batch1@example.com", "110101199001010010")
        );
        ...
        boolean batchUpdateResult = userService.updateBatchById(allUsers);
